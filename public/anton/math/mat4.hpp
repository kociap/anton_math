...
namespace anton::math {
    ...
    public:
        ...
        [[nodiscard]] Vec4& operator[](i32 const column) {
            return columns[column];
        }

        [[nodiscard]] Vec4 const& operator[](i32 const column) const {
            return columns[column];
        }
    ...
    [[nodiscard]] inline Mat4 operator+(Mat4 m, f32 const a) {
        m += a;
        return m;
    }
    ...
    [[nodiscard]] inline Mat4 operator+(Mat4 lhs, Mat4 const rhs) {
        lhs += rhs;
        return lhs;
    }
    ...
    [[nodiscard]] inline Vec4 operator*(Mat4 const lhs, Vec4 const rhs) {
        Vec4 r;
    ...
    [[nodiscard]] inline Mat4 transpose(Mat4 mat) {
    ...
    [[nodiscard]] inline static f32 _determinant3x3(f32 m00, f32 m01, f32 m02, f32 m10, f32 m11, f32 m12, f32 m20, f32 m21, f32 m22) {
        return m00 * m11 * m22 + m01 * m12 * m20 + m02 * m10 * m21 - m02 * m11 * m20 - m01 * m10 * m22 - m00 * m12 * m21;
    }

    [[nodiscard]] inline f32 determinant(Mat4 const m) {
    ...
    [[nodiscard]] inline Mat4 adjugate(Mat4 const m) {
    ...
    [[nodiscard]] inline Mat4 inverse(Mat4 const m) {
