...
namespace anton::math {
    ...
    [[nodiscard]] constexpr Vec3 operator-(Vec3 const& v) {
        return {-v.x, -v.y, -v.z};
    }
    ...
    [[nodiscard]] constexpr Vec3 operator+(Vec3 a, f32 b) {
        a += b;
        return a;
    }
    ...
    [[nodiscard]] constexpr Vec3 operator*(f32 b, Vec3 a) {
        a *= b;
        return a;
    }
    ...
    [[nodiscard]] constexpr bool is_almost_zero(Vec3 const v, f32 const tolerance = 0.000001f) {
        return math::abs(v.x) <= tolerance && math::abs(v.y) <= tolerance && math::abs(v.z) <= tolerance;
    }

    [[nodiscard]] constexpr f32 dot(Vec3 const v1, Vec3 const v2) {
        return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
    }

    [[nodiscard]] constexpr Vec3 cross(Vec3 const v1, Vec3 const v2) {
        return Vec3(v1.y * v2.z - v2.y * v1.z, v1.z * v2.x - v1.x * v2.z, v1.x * v2.y - v1.y * v2.x);
    }

    [[nodiscard]] constexpr f32 length_squared(Vec3 const v) {
        return v.x * v.x + v.y * v.y + v.z * v.z;
    }

    [[nodiscard]] inline f32 length(Vec3 v) {
    ...
    //
    [[nodiscard]] inline Vec3 normalize(Vec3 vec, f32 const tolerance = 0.000001f) {
    ...
    [[nodiscard]] constexpr Vec3 lerp(Vec3 const a, Vec3 const b, f32 const t) {
        return (1.0f - t) * a + t * b;
    }
